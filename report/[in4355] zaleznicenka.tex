...
For this project, Euclidean distance was used as distance function. However, one important adjustment was made to it to address the existence of continuous and non-continuous features. 

Some feature vectors in the data sets used to test the correctness of the algorithm shared both continuous (float values) and discrete (a string value from a set) features and to measure the distance correctly there was a need to 
...
\bibitem{Thirumuruganathan} S. Thirumuruganathan. A Detailed Introduction to K-Nearest Neighbor (KNN) Algorithm. \url{http://saravananthirumuruganathan.wordpress.com/2010/05/17/a-detailed-introduction-to-k-nearest-neighbor-knn-algorithm/}.
